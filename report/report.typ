...
#abstract([
  ...
  */
  ...
  The #course course required the development of a project to pass the class. In this context, the members of this group decided to create an Extended Reality experience to make people have the possibility to experience a horror game in a virtualized but immersive context.
  ...
  Thanks to the huge number of interactable objects and the recreated horror-like environment and experience, people can really feel immersed in a legitimate horror experience, despite certainly not having the same level of realism as other games like #link("https://store.steampowered.com/app/739630/Phasmophobia/")[Phasmophobia].
